...
Connector are the interfaces between the models (reactor, clarifier ...). To distinguish between inflow and outflow two connectors are build (InPipe ![InPipe](Docs/img/InPipe.png){:width="12px"}, OutPipe ![OutPipe](Docs/img/OutPipe.png){:width="12px"}). You can imagine that you connect two compartments with a pipe where the water and it's components flowing to or from a reactor. 
