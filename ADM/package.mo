...
//gas flow
    ...
    q_gas_norm_s = q_gas_norm /24/3600;
//derivatives
...
This Model is the single ADM1 model based on the Anearobic Sludge Model No.1 by the IWA
  ...
  package adm_only_examples
    model Digester
      OpenWasteWater.ADM.inflowADMonly testInflowDigester(Q = 400, Sin = OpenWasteWater.ADM.Solubles_ADM(su = 0, aa = 0, fa = 0, va = 0, bu = 0, pro = 0, ac = 0, H2 = 0, ch4 = 0, IC = 4, IN = 0.4, I = 37), T = 40, Xin = OpenWasteWater.ADM.Particulates_ADM(c = 207000, ch = 0, pr = 0, li = 0, su = 0, aa = 0, fa = 0, c4 = 0, pro = 0, ac = 0, H2 = 0, I = 2800)) annotation(
